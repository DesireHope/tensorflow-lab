...
# 下载的训练好的模型文件目录
MODEL_DIR = '/Users/user/PycharmProjects/tensorflow-second/chapter6/inception_dec_2015'

# 训练好的模型文件名
MODEL_FILE = 'tensorflow_inception_graph.pb'

# 特征向量保存地
CACHE_DIR = '/Users/user/PycharmProjects/tensorflow-second/chapter6/tmp/bottleneck'

# 图片数据文件夹。
# 在这个文件夹中每个子文件夹代表一个需要区分的类别，每个子文件夹中存放了对应类别的图片
INPUT_DATA = '/Users/user/PycharmProjects/tensorflow-second/chapter6/flower_photos'
